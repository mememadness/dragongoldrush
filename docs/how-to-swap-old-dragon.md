...
> guide shows the exact flow, captured from the live test build. *(Delete this
> note at launch.)*
...
![Title screen with wallet connected](images/swap-01-title-connected.png)
...
![Wallet menu with the swap button](images/swap-02-wallet-menu.png)
...
![Swap window with the amount prefilled](images/swap-03-dialog-prefilled.png)
...
![Amount entered, ready to exchange](images/swap-04-amount-entered.png)
...
![Sent — waiting for confirmation](images/swap-05-sent-waiting.png)
