...
This roadmap tracks the major development milestones for Dragon Gold Rush. For detailed weekly progress, see the [Weekly Updates](https://github.com/mememadness/dragongoldrush/tree/main/WeeklyUpdates).
...
- **New:** a player guide — [How to Play Story Mode](how-to-play-story-mode.md)

## New Coin (DGC) & Swap Desk 🔄 In Progress

![The old plain coin transforming into the new DGC dragon coin](assets/images/swap-transform.webp){: .illustration }
...
- **Guides ready for launch:** [How to Swap Your Old DRAGON](how-to-swap-old-dragon.md)
